...
function my_autoload($className) {
	...
	// echo $className;
	$filePath = $sourcedir . LikePosts::$sourceFolder . $className . '.php';
...
class LikePosts {
	...
	public function __construct() {
		...
		require_once ($sourcedir . self::$sourceFolder . '/LikePostsUtils.php');
		echo $sourcedir . self::$sourceFolder . '/LikePostsUtils.php';
		self::$lpUtils = new LikePostsUtils();
	}

	public static function addActionContext(&$actions) {
		$actions['likeposts'] = array(LikePosts::$sourceFolder . 'LikeUnlikePosts.php', 'LikePosts::mainIndex');
		$actions['likepostsstats'] = array(LikePosts::$sourceFolder . 'LikePostsStats.php', 'LikePostsStats::mainIndex');
	}
